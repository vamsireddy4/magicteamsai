              ...
              try {
                ...
                if (stateRes.ok) {
                  ...
                  if (rows?.[0]?.call_control_id) {
                    ...
                    console.log(`[SARVAM-BRIDGE] Resolved Telnyx call_control_id from telnyx_call_state: ${callSid}`);
                  }
                }
              } catch (e) { console.warn("[SARVAM-BRIDGE] telnyx_call_state lookup failed:", e); }
                ...
                try {
                  ...
                  if (logRes.ok) {
                    ...
                    if (rows?.[0]?.twilio_call_sid) {
                      ...
                      console.log(`[SARVAM-BRIDGE] Resolved Telnyx call_control_id from call_logs: ${callSid}`);
                    }
                  }
                } catch (e) { console.warn("[SARVAM-BRIDGE] call_logs lookup failed:", e); }
              }
            }
